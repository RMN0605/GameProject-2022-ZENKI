...
public class MenuImage : MonoBehaviour
{
    ...
    // ‰æ‘œ‚ð·‚µ‘Ö‚¦‚é‘¬“x
    [SerializeField,Tooltip("‰æ‘œ‚ð·‚µ‘Ö‚¦‚é‘¬“x")]
    private float fps = 0.1f;
    [SerializeField,Tooltip("‰æ‘œ‚ð“ü‚ê‚éêŠ")]
    private List<Sprite> sprites = new List<Sprite>();
    [SerializeField,Tooltip("–Ú•W’n“_")]
    private float destination = 1.5f;
    [SerializeField, Tooltip("–Ú•W’n“_2")]
    ...
    // ƒRƒ‹[ƒ`ƒ“‚ÌŽÀs‚ªI‚í‚Á‚½‚Ì‚©‚Ì”»’è
    [SerializeField, Tooltip("ƒRƒ‹[ƒ`ƒ“I—¹”»’è")]
